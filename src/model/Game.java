...
public class Game implements GameControl, GameInfoProvider {
    ...
    protected void update() {
        ...
        /**
         * Iterates through laserList. If the laser game object is destroyed,
         * remove it out of the list, otherwise update
         */
    ...
    public List<GameObject> getGameObjects() {
        ...
        /**
         * Instead of adding single lasers, add more than one inside a list!
         */
    ...
    /**
     * Add a laser to the game. The laser recharges once every .5seconds (500ms)
     * @param laser the laser to be added to the game
     */
    protected void addLaser(Laser laser) {
    	/**
    	 * add a laser inside laserList
    	 */
    	 if (System.currentTimeMillis() - currentTime >= COOLDOWN) {
    		 ...
    		 long timeRemaining = System.currentTimeMillis() - currentTime;
    		 System.out.println("Laser On Cooldown: " + timeRemaining + "ms left!");
    	 }
    ...
    /**
     * @return the number of invaders remaining
     */
	public int invaderRemaining() {
